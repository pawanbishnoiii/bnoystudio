    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-6xl h-[80vh] bg-white rounded-2xl overflow-hidden border border-border shadow-card-hover"
        >
          <div className="flex items-center justify-between p-3 border-b border-border bg-warm-bg">
