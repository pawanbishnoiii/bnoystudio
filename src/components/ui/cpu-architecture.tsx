    ...
    >
      ...
      {[1,2,3,4,5,6,7,8].map((n) => (
        <g key={n} mask={`url(#cpu-mask-${n})`}>
          <circle className={`cpu-architecture cpu-line-${n}`} cx="0" cy="0" r="8" fill={`url(#cpu-grad-${n})`} />
        </g>
      ))}
      ...
      <defs>
        ...
        {[
          ["cpu-grad-1", "#00E8ED", "#08F"],
          ["cpu-grad-2", "#FFD800", "#FFD800"],
          ["cpu-grad-3", "#830CD1", "#FF008B"],
          ["cpu-grad-4", "#ffffff", "#ffffff"],
          ["cpu-grad-5", "#22c55e", "#22c55e"],
          ["cpu-grad-6", "#f97316", "#f97316"],
          ["cpu-grad-7", "#06b6d4", "#06b6d4"],
          ["cpu-grad-8", "#f43f5e", "#f43f5e"],
        ].map(([id, c1, c2]) => (
